...
<head>
  ...
  <title>Tienda e-commerce (EOM) 5</title>
...
<div class="stack">
                        ...
                        <div class="as-accordion-content">
                          <ul class="as-search-filter-items  as-filter-text-type    ">
                            <li class="as-filter-item       ">
                              <a href="" class="as-filter-option  " aria-disabled="false" tabindex="0"
                                 data-tracking="ipadCompatibility=ipadpro_12_9_2, " role="checkbox"
                                 aria-checked="false">
                            ...
                            <li class="as-filter-item       ">
                              <a href="" class="as-filter-option  " aria-disabled="false" tabindex="0"
                                 data-tracking="ipadCompatibility=ipadpro_12_9, " role="checkbox" aria-checked="false">
                                <span class="as-filter-name">
                                    <span class="as-search-filter-content">
                                        <span class="as-search-filter-text">
                                            LG
                            ...
                            <li class="as-filter-item       ">
                              <a href="" class="as-filter-option  " aria-disabled="false" tabindex="0"
                                 data-tracking="ipadCompatibility=ipadpro_10_5, " role="checkbox" aria-checked="false">
                                <span class="as-filter-name">
                                    <span class="as-search-filter-content">
                                        <span class="as-search-filter-text">
                                            Motorola
                            ...
                            <li class="as-filter-item       ">
                              <a href="" class="as-filter-option  " aria-disabled="false" tabindex="0"
                                 data-tracking="ipadCompatibility=ipadpro_9_7, " role="checkbox" aria-checked="false">
                            ...
                            <li class="as-filter-item       ">
                              <a href="" class="as-filter-option  " aria-disabled="false" tabindex="0"
                                 data-tracking="ipadCompatibility=ipad_9_7, " role="checkbox" aria-checked="false">
                            ...
                            <li class="as-filter-item       ">
                              <a href="" class="as-filter-option  " aria-disabled="false" tabindex="0"
                                 data-tracking="ipadCompatibility=ipad6gen, " role="checkbox" aria-checked="false">
              ...
              <div class="as-producttile large-4 small-6 group-1">
                <div class="as-producttile-tilehero with-paddlenav with-paddlenav-onhover">
                  <div class="as-dummy-container as-dummy-img">
                    ...
                    <img src="./assets/samsung-galaxy-s9-xxl.jpg" class="ir ir item-image as-producttile-image  " alt=""
              ...
              <div class="as-producttile large-4 small-6 group-1">
                <div class="as-producttile-tilehero with-paddlenav with-paddlenav-onhover">
                  <div class="as-dummy-container as-dummy-img">
                    ...
                    <img src="./assets/l6g6.jpg" class="ir ir item-image as-producttile-image " alt="" width="445"
                         height="445">
                  </div>
                    ...
                    <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                      <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink"
                        ...
                        <div class="as-tilegallery-element as-image-selected">
                          <div class=""></div>
                          <img src="./assets/l6g6.jpg" class="ir ir item-image as-producttile-image" alt="" width="445"
                               height="445" data-desc="LG G6" style="">
                        </div>
                      ...
                      <ul class="clearfix">
                        <li class="as-searchtile-mobile">
                          <img src="./assets/MQD92"
                               class="ir as-util-relatedlink item-image as-producttile-image relatedlink" alt=""
                               width="445" height="445"
              ...
              <div class="as-producttile large-4 small-6 group-1">
                <div class="as-producttile-tilehero with-paddlenav with-paddlenav-onhover">
                  ...
                  <div class="images mini-gallery gal0 ">
                    <ul class="clearfix as-producttile-nojs">
                      <li class="as-searchtile-nojs">
                        <img src="./assets/MMEF2" class="ir relatedlink item-image as-producttile-image" alt=""
                             width="445" height="445"
                    ...
                    <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                      <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink"
                        ...
                        <div class="as-tilegallery-element as-image-selected">
                          ...
                          <img src="./assets/Screen Shot 2017-11-01 at 13.01.54.png"
                               class="ir ir item-image as-producttile-image" alt="" width="445" height="445"
                               data-desc="AirPods - Image 1 ">
                        </div>
                        <div class="as-tilegallery-element">
                          <div class=""></div>
                          <img src="./assets/u_10168742.jpg" class="ir ir item-image as-producttile-image" alt=""
                               width="445" height="445">
                        </div>
                      </div>
                    </div>
                ...
                <div class="as-producttile-info" style="min-height: 168px;">
                  <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                    <div class="as-producttile-title">
                      <h3 class="as-producttile-name">
                        <div class="as-producttile-tilelink relatedlink" data-var-name="s.prop27|s.prop29"
              ...
              <div class="as-producttile large-4 small-6 group-2">
                <div class="as-producttile-tilehero with-paddlenav with-paddlenav-onhover">
                  <div class="as-dummy-container as-dummy-img">
                    ...
                    <img src="./assets/wireless-headphones" class="ir ir item-image as-producttile-image  " alt=""
                         width="445" height="445">
                  </div>
                  <div class="images mini-gallery gal3 ">
                    ...
                    <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                      <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink"
                        ...
                        <div class="as-tilegallery-element as-image-selected">
                          <div class=""></div>
                          <img src="./assets/motorola-moto-g5-plus-1.jpg" class="ir ir item-image as-producttile-image"
                               alt="" width="445" height="445" data-desc="BeatsX Earphones - Matte Silver - Image 1 "
  ...
  <div style="text-align: center; padding: 20px">
    ...
    <form action="hook-ipn.php" method="post">
      ...
      <input type="hidden" name="price" value="10000">
      <input type="hidden" name="unit" value="1">
      <button type="submit" class="mercadopago-button" formmethod="post">Test Log IPN o WebHook</button>
    </form>
  </div>

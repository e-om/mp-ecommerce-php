            ...
            <div class="width:60%">
                    ...
                    <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink"
                      ...
                      <div class="as-tilegallery-element as-image-selected">
                        ...
                        <img src="./assets/003.jpg" class="ir ir item-image as-producttile-image" alt="" width="445"
                             height="445" style="content:-webkit-image-set(url(<?php echo $_POST['img'] ?>) 2x);">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="as-producttile-info" style="float:left;min-height: 168px;">
                <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                  ...
                  <h3>
                      Cantodad: <?php echo $_POST['unit']; ?>
                  </h3>
                </div>

                <?php if(isset($IdMpCheckOut)): ?>
<!--                <form action="pagos-mp.php" method="POST">-->
<!--                  <script src="https://www.mercadopago.com.ar/integrations/v1/web-payment-checkout.js" data-preference-id="--><?php //echo $IdMpCheckOut; ?><!--">-->
<!--                  </script>-->
<!--                </form>-->
                <?php endif; ?>
                <a href="<?php echo $linkDePagoUrl; ?>" class="mercadopago-button" style="padding: 10px">Pagar la compra</a>
              </div>
            </div>
          </div>
        </div>
